...
class DFNet(nn.Module):
    ...
    def evaluate(self, dev, matric_best, output=False, early_stop=None):
        ...
        for j, data_dev in pbar:
            ...
            for bi, row in enumerate(decoded_fine):
                ...
                if args['genSample']:
                    self.print_examples(bi, data_dev, pred_sent, pred_sent_coarse, gold_sent, gold_sketch_response, dialog_plain)
    ...
    def print_examples(self, batch_idx, data, pred_sent, pred_sent_coarse, gold_sent, gold_sketch_response, dialog_plain):
