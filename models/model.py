...
class DFNet(nn.Module):
    ...
    def encode_and_decode(self, data, max_target_length, use_teacher_forcing, get_decoded_words,
        ...
        global_pointer, kb_readout, ent_pointer, kb_emb, kb_output, kb_ent_hdd = self.extKnow.load_memory(
            story,
            data['kb_arr_lengths'],
            data['conv_arr_lengths'],
            sket_hidden,
        ...
        concat_hidden = torch.cat((sket_hidden, kb_readout, dh_hidden), dim=-1)
