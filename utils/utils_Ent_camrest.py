        ...
        for line in fin:
            ...
            if line:
                ...
                if '\t' in line:
                    ...
                    ent_idx_cal, ent_idx_nav, ent_idx_restaurant = [], [], []
                    ...
                    ent_index = list(set(ent_idx_cal + ent_idx_nav + ent_idx_restaurant))
...
def prepare_data_seq(batch_size=100):
    file_train = 'data/CamRest/train_1.txt'
    file_dev = 'data/CamRest/dev_1.txt'
    file_test = 'data/CamRest/test_1.txt'
